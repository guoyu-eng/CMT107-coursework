/**
 * VCCW01 - OpenGL Coursework 1
 *
 * This program implements a simple OpenGL application using JOGL (Java Bindings for OpenGL).
 * It creates an OpenGL window, sets up a scene with a teapot, and allows interaction through
 * key events for scaling, translation, and rotation of the teapot.
 *
 * Dependencies:
 ...
 * - KeyListener: Listens for key events to enable user interaction.
 * - FPSAnimator: Controls the animation loop.
 * - Renderer: Inner class implementing GLEventListener and KeyListener for rendering and interaction.
